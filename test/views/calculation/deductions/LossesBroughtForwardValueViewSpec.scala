  ...
  "Losses Brought Forward Value view" when {
    ...
    "provided with a date in the 2015/16 tax year" should {
      ...
      lazy val view = lossesBroughtForwardValueView(lossesBroughtForwardValueForm, taxYear, "back-link",
        controllers.routes.DeductionsController.submitLossesBroughtForwardValue)(using fakeRequest, mockMessage, fakeLang)
      ...
      "have a dynamic navTitle of navTitle" in {
        doc.body.getElementsByClass("govuk-service-navigation__service-name").text() shouldBe "Calculate your Capital Gains Tax"
      }
