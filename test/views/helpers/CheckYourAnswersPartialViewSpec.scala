  ...
  "The check your answers partial with as much filled in as possible" should {
    ...
    "has an option output row for brought forward losses" which {
      ...
      s"should have the question text '${baseMessages.LossesBroughtForward.title("2015/16")}'" in {
        doc.select("#broughtForwardLosses-question").text shouldBe baseMessages.LossesBroughtForward.title("2015/16")
      }
      ...
      "has the question as part of the link" in {
        doc.select("#broughtForwardLosses-option a").text shouldBe s"${commonMessages.change} ${baseMessages.LossesBroughtForward.question("2015/16")}"
      }

      "has the question component of the link as visuallyhidden" in {
        doc.select("#broughtForwardLosses-option a span.visuallyhidden").text shouldBe baseMessages.LossesBroughtForward.question("2015/16")
      }
    }
  ...
  "The check your answers partial with as little filled in as possible" should {
    ...
    "has an option output row for sold for less than worth value in" which {
      ...
      "should have the value '£3,000'" in {
        doc.select("#worthWhenSoldForLess-amount span.bold-medium").text shouldBe "£3,000"
      }
    ...
    "has a numeric output row for the Disposal Costs" which {
      ...
      "should have the value '£200'" in {
        doc.select("#disposalCosts-amount span.bold-medium").text shouldBe "£200"
      }
