...
class GainSummaryActionSpec @Inject()(pdfGenerator: PdfGenerator) extends CommonPlaySpec with WithCommonFakeApplication with FakeRequestHelper with MockitoSugar {
