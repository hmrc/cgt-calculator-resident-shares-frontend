...
class AllowableLossesValueActionSpec extends UnitSpec with WithFakeApplication with FakeRequestHelper with MockitoSugar {
  ...
  def setupTarget(getData: Option[AllowableLossesValueModel],
    ...
    when(mockCalcConnector.saveFormData[AllowableLossesValueModel](ArgumentMatchers.any(), ArgumentMatchers.any())(ArgumentMatchers.any(), ArgumentMatchers.any()))
  ...
  "Calling .allowableLossesValue from the DeductionsController" when {
    ...
    "there is no keystore data" should {
      ...
      s"has the action '${controllers.routes.DeductionsController.submitAllowableLossesValue().toString}'" in {
